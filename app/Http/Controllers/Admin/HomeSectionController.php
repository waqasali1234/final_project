...
class HomeSectionController extends MainAdminController
{
    ...
    public function update_home_section(Request $request)
    {
        ...
        $settings->section5_status=$inputs['section5_status'];
       $settings->section5_status= $request->section5_status;
       $settings->section6_status= $request->section6_status;
       $settings->section7_status= $request->section7_status;
//dd($settings);
	    $settings->save();
