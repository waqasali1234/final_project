...
--
-- Host: 127.0.0.1
-- Generation Time: Sep 12, 2021 at 06:09 AM
...
CREATE TABLE `home_section` (
  ...
  `section5_status` varchar(255) NOT NULL,
  `section6_status` varchar(255) NOT NULL,
  `section7_status` varchar(255) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
INSERT INTO `home_section` (`id`, `section1_latest_movie`, `section2_latest_series`, `section3_popular_movie`, `section3_popular_series`, `section3_title`, `section3_type`, `section3_lang`, `section4_title`, `section4_type`, `section4_lang`, `section5_title`, `section5_type`, `section5_lang`, `section5_status`, `section6_status`, `section7_status`) VALUES
(1, '23,21,19,17,16,15,10,9', '5,4,3,1', '23,21,19,14,12,11,9', '6,4,2', 'English Movies', 'Movie', 2, 'Hindi Series', 'Series', 1, 'Hindi Movies', 'Movie', 1, '1', '1', '1');
...
CREATE TABLE `payments` (
  ...
  `video_slug` varchar(200) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_nopad_ci DEFAULT NULL,
  `video_access` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_520_nopad_ci DEFAULT NULL,
  `video_image_thumb` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_520_ci DEFAULT NULL,
...
INSERT INTO `payments` (`id`, `movie_id`, `user_id`, `plan`, `amount`, `video_slug`, `video_access`, `video_image_thumb`, `video_title`, `duration`, `time`, `expiry_date`) VALUES
(19, 30, 6, 'day', '10', 'thor', 'Paid', 'img.png', 'THOR', NULL, '2021-09-11 07:30:22', NULL),
(20, 29, 6, 'day', '6', 'qui-tempora-inventor', 'Paid', 'L_LifeOfBillionaires.jpg', 'Qui tempora inventor', 'Sed fugit reprehend', '2021-09-11 07:30:22', NULL),
(36, 25, 6, 'day', '5', 'baywatch', 'Free', 'MV5BNTA4MjQ0ODQzNF5BMl5BanBnXkFtZTgwNzA5NjYzMjI@._V1_SX300.jpg', 'Baywatch', '116 min', '2021-09-11 11:48:24', '2021-09-11 19:00:00'),
(37, 26, 6, 'day', '935', 'guardians-of-the-galaxy-vol-2', 'Paid', 'MV5BNjM0NTc0NzItM2FlYS00YzEwLWE0YmUtNTA2ZWIzODc2OTgxXkEyXkFqcGdeQXVyNTgwNzIyNzg@._V1_SX300.jpg', 'Guardians of the Galaxy Vol. 2', '136 min', '2021-09-11 12:05:07', '2021-09-12 12:35:07');
...
--
ALTER TABLE `payments`
  MODIFY `id` int(123) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=38;
