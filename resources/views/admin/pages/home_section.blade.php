                ...
                @endif
                 ...
                 {!! Form::open(array('url' => array('admin/home_section'),'class'=>'form-horizontal','name'=>'settings_form','id'=>'settings_form','role'=>'form','enctype' => 'multipart/form-data')) !!}
                  ...
                  <div class="form-group row">
                    ...
                    <div class="form-group row">
                        <label class="col-sm-3 col-form-label">{{trans('Section 5 Status')}}</label>
                        <div class="col-sm-8">
                            <div class="radio radio-success form-check-inline"  style="margin-top: 8px;">
                                <input type="radio" id="inlineRadio3" value="1" name="section5_status" @if(isset($home_settings->section5_status) && $home_settings->section5_status==1) {{ 'checked' }} @endif>
                                <label for="inlineRadio3"> {{trans('words.active')}} </label>
                            </div>
                            <div class="radio form-check-inline" style="margin-top: 8px;">
                                <input type="radio" id="inlineRadio4" value="0" name="section5_status" @if(isset($home_settings->section5_status) && $home_settings->section5_status==0) {{ 'checked' }} @endif {{ isset($home_settings->id) ? '' : 'checked' }}>
                  ...
                  <div class="form-group row">
                    ...
                    <div class="form-group row">
                        <label class="col-sm-3 col-form-label">{{trans('Section 6 Status')}}</label>
                        <div class="col-sm-8">
                            <div class="radio radio-success form-check-inline"  style="margin-top: 8px;">
                                <input type="radio" id="inlineRadio3" value="1" name="section6_status" @if(isset($home_settings->section6_status) && $home_settings->section6_status==1) {{ 'checked' }} @endif>
                                <label for="inlineRadio3"> {{trans('words.active')}} </label>
                            </div>
                            <div class="radio form-check-inline" style="margin-top: 8px;">
                                <input type="radio" id="inlineRadio4" value="0" name="section6_status" @if(isset($home_settings->section6_status) && $home_settings->section6_status==0) {{ 'checked' }} @endif {{ isset($home_settings->id) ? '' : 'checked' }}>
                                <label for="inlineRadio4"> {{trans('words.inactive')}} </label>
                            </div>
                        </div>
                    </div>
                  ...
                  <div class="form-group row">
                    ...
                    <div class="form-group row">
                        <label class="col-sm-3 col-form-label">{{trans('Section 7 Status')}}</label>
                        <div class="col-sm-8">
                            <div class="radio radio-success form-check-inline"  style="margin-top: 8px;">
                                <input type="radio" id="inlineRadio3" value="1" name="section7_status" @if(isset($home_settings->section7_status) && $home_settings->section7_status==1) {{ 'checked' }} @endif>
                                <label for="inlineRadio3"> {{trans('words.active')}} </label>
                            </div>
                            <div class="radio form-check-inline" style="margin-top: 8px;">
                                <input type="radio" id="inlineRadio4" value="0" name="section7_status" @if(isset($home_settings->section7_status) && $home_settings->section7_status==0) {{ 'checked' }} @endif {{ isset($home_settings->id) ? '' : 'checked' }}>
                                <label for="inlineRadio4"> {{trans('words.inactive')}} </label>
                            </div>
                        </div>
                    </div>
